...
> [Documentation](https://pysal.org/spml).

Before you ask a question, it is best to search for existing
[Issues](https:/github.com/pysal/spml/issues) that might help you. In case you have
...
- Open an [Issue](https:/github.com/pysal/spml/issues/new).
...
- To see if other users have experienced (and potentially already solved) the same issue
  ...
  error in the [bug tracker](https:/github.com/pysal/spml/issues?q=label%3Abug).
...
- Open an [Issue](https:/github.com/pysal/spml/issues/new). (Since we can't be sure
...
This section guides you through submitting an enhancement suggestion for SpML,
...
- Make sure that you are using the latest version.
- Read the [documentation](https://pysal.org/spml) carefully and find out if the
  functionality is already covered, maybe by an individual configuration.
- Perform a [search](https:/github.com/pysal/spml/issues) to see if the enhancement
...
[GitHub issues](https:/github.com/pysal/spml/issues).
...
- **Describe the current behavior** and **explain which behavior you expected to see
  ...
  you.
- **Explain why this enhancement would be useful** to most SpML users. You may also
...
```sh
conda env create -f ci/py313_latest.yaml -n spml
```

To install `spml` to the Conda environment in an editable form, clone the repository,
...
- `spml` supports Python versions according to
